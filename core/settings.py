...
from django_petra.config.database import DatabaseConfig
...
SECRET_KEY = 'django-insecure-w5@9i(i52)-+mr09boh4+-shv5yod*f$auxl9k)%##h)70ct%o'
...
DATABASES = {
    'default': DatabaseConfig.get_database_settings()
}
